...
const FILES: &[BundledFile] = &[
    BundledFile {
        ...
        contents: include_str!("../ose_ability.ttrpg"),
    },
    BundledFile {
        name: "ose_chargen.ttrpg",
        contents: include_str!("../ose_chargen.ttrpg"),
    },
    BundledFile {
        name: "ose_class.ttrpg",
        contents: include_str!("../ose_class.ttrpg"),
    },
    BundledFile {
        name: "ose_combat.ttrpg",
        contents: include_str!("../ose_combat.ttrpg"),
    },
    BundledFile {
        name: "ose_core.ttrpg",
        contents: include_str!("../ose_core.ttrpg"),
    },
    BundledFile {
        name: "ose_equipment.ttrpg",
        contents: include_str!("../ose_equipment.ttrpg"),
    },
    BundledFile {
        name: "ose_exploration.ttrpg",
        contents: include_str!("../ose_exploration.ttrpg"),
    },
    BundledFile {
        name: "ose_magic.ttrpg",
        contents: include_str!("../ose_magic.ttrpg"),
    },
    BundledFile {
        name: "ose_saves.ttrpg",
        contents: include_str!("../ose_saves.ttrpg"),
    },
    BundledFile {
        name: "ose_spells.ttrpg",
        contents: include_str!("../ose_spells.ttrpg"),
    },
    BundledFile {
        name: "ose_thief.ttrpg",
        contents: include_str!("../ose_thief.ttrpg"),
    },
    BundledFile {
        name: "ose_time_economy.ttrpg",
        contents: include_str!("../ose_time_economy.ttrpg"),
    },
    BundledFile {
        name: "ose_wilderness.ttrpg",
        contents: include_str!("../ose_wilderness.ttrpg"),
    },
];
